...
export function HeroBanner() {
  ...
  const heroStats = homeContent.organizationStats.slice(0, 3)
            ...
            <div className="space-y-6 text-center lg:space-y-8 lg:text-left">
              ...
              <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:justify-center lg:justify-start">
                <Button
                  ...
                  onClick={() => scrollToSection(hero.primaryAction.targetId)}
                >
                ...
                <Button
                  ...
                  onClick={() => scrollToSection(hero.secondaryAction.targetId)}
                >
              ...
              <button
                ...
                onClick={() => scrollToSection(hero.tertiaryAction.targetId)}
              >
